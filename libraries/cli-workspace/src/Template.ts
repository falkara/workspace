import type { Files } from '@falkara/cli-kernel';
...
/**
 * `package.json` is written through `JSON.stringify` rather than as a template
 * string, so a name containing a quote produces an escaped string rather than a
 * broken file.
 */
 ...
 */
// TODO: grow this into the real Falkara Workspace project layout.
